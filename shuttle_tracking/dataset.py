...
if __name__ == '__main__':
    prepare_dataset(root_dir='data_co/shuttle', output_dir='data_yolo/shuttle', train=True, rm_files=True)
    prepare_dataset(root_dir='data_co/shuttle', output_dir='data_yolo/shuttle', train=False, rm_files=False)
